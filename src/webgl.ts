...
export default class WebGLContext {
  ...
  drawImage() {
    ...
    ctx.uniform2f(this.sizeUniformLocation, this.cnv.width, this.cnv.height);
    ctx.uniform1f(this.timeUniformLocation, Date.now() - this.startTime);
    ...
    const draw = () => {
      ...
      // Update value of u_time uniform
      ctx.uniform1f(this.timeUniformLocation, time);
